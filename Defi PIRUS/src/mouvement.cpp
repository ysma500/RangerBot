...
void Mouv_infra()
{
	...
	if (capteur_mov[DEVANT_MOV] > 300) //Mur en avant, on compare les valeurs des capteurs de chaque cote pour savoir ou tourner
	{
	...
	else if (capteur_mov[DROIT_MOV] <= 170) //Plus loins que la 2e zone tampon
	{
